...
class Icreat(models.Model):
    ...
    period = models.CharField(max_length=20, verbose_name='연구기간', blank=True, null=True)
    ...
    trial = models.CharField(max_length=100, verbose_name='임상시험단계(연구모형)', blank=True, null=True)
    goal_research = models.IntegerField(verbose_name='전체목표연구대상자수', blank=True, null=True)
